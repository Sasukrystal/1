...
public class EquipmentSlot : Slot
{
    ...
    public bool IsRightItem(Item item)
    {
        ...
        {
            if (this.wpType == Weapon.WeaponType.MainHand)
            {
                return weapon.WpType == Weapon.WeaponType.MainHand || weapon.WpType == Weapon.WeaponType.Dagger;
            }

            if (this.wpType == Weapon.WeaponType.OffHand)
            {
                return weapon.WpType == Weapon.WeaponType.OffHand || weapon.WpType == Weapon.WeaponType.Wand;
            }

            return weapon.WpType == this.wpType;
        }
